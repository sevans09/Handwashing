...
options(repr.plot.width=7, repr.plot.height=4)
ggplot(monthly, aes(x = proportion_deaths, y = date)) + geom_line() + labs(x = "Proportion of deaths", y = "Date")
...
ggplot(monthly, aes(x = date, y = proportion_deaths, color = handwashing_started)) + geom_line() + labs(x = "Proportion of deaths", y = "Date")
